...
export const LANE_EVENT_TYPES = Object.freeze({
  ...
  AUTO_WORK_CREATE_REQUESTED: "AUTO_WORK_CREATE_REQUESTED",
  AUTO_WORK_TARGET_PERSISTED: "AUTO_WORK_TARGET_PERSISTED",
  AUTO_WORK_DISPATCH_CONFIRMED: "AUTO_WORK_DISPATCH_CONFIRMED",
  AUTO_WORK_CREATE_AMBIGUOUS: "AUTO_WORK_CREATE_AMBIGUOUS",
...
const REASON_CODES = new Set([
  ...
  "AUTO_WORK_CREATE_RESTART_AMBIGUOUS",
  "OWNER_WORK_TARGET_REQUIRED",
  "AUTO_WORK_TARGET_NOT_CANONICAL_C",
